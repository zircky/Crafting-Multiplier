...
--if type(science_multiplier) == "number" and science_multiplier > 1 then
--  log("data-final-fixes: applying science multiplier to numeric unit.count: " .. tostring(science_multiplier))
--  for tech_name, tech in pairs(data.raw.technology) do
--    if tech.unit and tech.unit.count and type(tech.unit.count) == "number" then
--      local old = tech.unit.count
--      tech.unit.count = math.max(1, old * science_multiplier)
--      log("data-final-fixes: scaled unit.count for " .. tech_name .. ": " .. old .. " -> " .. tech.unit.count)
--    end
--  end
--else
--  log("data-final-fixes: science_multiplier <=1 — skipping numeric tech scaling")
--end
